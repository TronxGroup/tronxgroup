...
function Pill({ children }: { children: ReactNode }) {
  return (
    <span className="inline-flex items-center rounded-full bg-sky-500/15 text-sky-200 border border-sky-500/30 px-3 py-1 text-xs font-medium backdrop-blur">
      {children}
    </span>
  );
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            <GlassCard className="p-6 lg:col-span-3">
              ...
              <form onSubmit={submitMailto} className="mt-6 grid grid-cols-1 gap-4">
                <div className="field">
                  <label className="label text-blue-100">Nombre</label>
                  <input name="name" required className="input bg-white text-slate-900" placeholder="Nombre y apellido" />
                </div>
                <div className="field">
                  <label className="label text-blue-100">Email</label>
                  <input type="email" name="email" required className="input bg-white text-slate-900" placeholder="tu@email.cl" />
                </div>
                <div className="field">
                  <label className="label text-blue-100">Mensaje</label>
                  <textarea name="message" className="textarea bg-white text-slate-900" placeholder="Breve contexto y objetivo" />
                </div>
                <div className="flex flex-wrap gap-3">
                  <button type="submit" className="btn btn-primary">Enviar</button>
                  <a href="/catalogo/tronxgroup_catalogo_2026.pdf" className="btn border border-white/30 text-white hover:bg-white/10" download>
                    Descargar catálogo
                  </a>
                </div>
              </form>
