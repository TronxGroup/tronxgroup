...
const XIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1227" className="w-5 h-5 fill-current" aria-hidden="true">
...
export default function Landing() {
  ...
  const reCaptchaAlert6988454000000768151 = useCallback(() => {
    ...
    if (recap && recap.getAttribute('data-captcha-verified') === 'false') {
  ...
  // === Callback global que llama reCAPTCHA (cliente) ===
  useEffect(() => {
    window.rccallback6988454000000768151 = () => {
      const recap = document.getElementById('recap6988454000000768151');
      if (recap) recap.setAttribute('data-captcha-verified', 'true');
      const err = document.getElementById('recapErr6988454000000768151') as HTMLDivElement | null;
  ...
  return (
    <main id="top" className="bg-black text-white">
      ...
      <header className="sticky top-0 z-40 bg-black/70 backdrop-blur border-b border-zinc-800">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          <a href="#top" className="inline-flex items-center gap-3">
            <Image src="/tronxgrouplogo.png" alt="Tronx Group" width={32} height={32} className="rounded" priority />
            <span className="font-semibold tracking-tight">Tronx Group</span>
          </a>
          <nav className="flex items-center gap-5 text-gray-400">
            <a href="https://wa.me/56920080031" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:text-[#25D366] transition" aria-label="WhatsApp Tronx Group">
              <WhatsAppIcon />
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[90vh] text-center px-6">
        <motion.h1 initial={fadeUp.initial} whileInView={fadeUp.whileInView} transition={fadeUp.transition} viewport={{ once: true }} className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
          Tronx Group
        </motion.h1>

        <motion.p initial={fadeUp.initial} whileInView={fadeUp.whileInView} transition={{ ...fadeUp.transition, delay: 0.15 }} viewport={{ once: true }} className="max-w-2xl text-lg md:text-xl text-gray-300 mb-8">
          Holding creativo-tecnológico que une estrategia, contenido y sistemas para construir crecimiento real, medible y con propósito.
        </motion.p>
        ...
        <motion.div initial={fadeUp.initial} whileInView={fadeUp.whileInView} transition={{ ...fadeUp.transition, delay: 0.45 }} viewport={{ once: true }} className="absolute bottom-8 text-sm text-gray-500">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 space-y-16">
        <motion.div initial={fadeUp.initial} whileInView={fadeUp.whileInView} transition={fadeUp.transition} viewport={{ once: true }} className="text-center">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto">
            Cada marca refleja una energía: estrategia, comunicación, expansión y estructura. Juntas forman un sistema diseñado para el crecimiento B2B moderno.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <motion.div initial={fadeUp.initial} whileInView={fadeUp.whileInView} transition={fadeUp.transition} viewport={{ once: true }} className="bg-zinc-900 rounded-2xl p-8 border border-zinc-800">
            ...
            <p className="text-gray-400 mb-4">
              Unidad de crecimiento B2B. Estrategia, CRM, automatización y performance marketing. Operación digital rápida y medible.
            </p>
          ...
          <motion.div initial={fadeUp.initial} whileInView={fadeUp.whileInView} transition={{ ...fadeUp.transition, delay: 0.1 }} viewport={{ once: true }} className="bg-zinc-900 rounded-2xl p-8 border border-zinc-800">
            ...
            <p className="text-gray-400 mb-4">
              Estudio audiovisual estratégico. Videos, reels, vodcasts y piezas cinematográficas que transmiten propósito y emoción.
            </p>
            <ul className="text-sm text-gray-400 space-y-1 mb-4">
          ...
          <motion.div id="tronxtv" initial={fadeUp.initial} whileInView={fadeUp.whileInView} transition={{ ...fadeUp.transition, delay: 0.2 }} viewport={{ once: true }} className="bg-zinc-900 rounded-2xl p-8 border border-zinc-800">
            ...
            <p className="text-gray-400 mb-4">
              Plataforma editorial de contenidos originales en video. Historias, documentales y realities sobre liderazgo, innovación y conciencia.
            </p>
            <ul className="text-sm text-gray-400 space-y-1 mb-4">
      ...
      <section className="bg-zinc-950 py-24 px-6">
        <motion.div initial={fadeUp.initial} whileInView={fadeUp.whileInView} transition={fadeUp.transition} viewport={{ once: true }} className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-gray-400 leading-relaxed">
            Tronx Group nace de la idea de que el crecimiento no se mide solo en cifras, sino en impacto real. Combinamos tecnología, comunicación y conciencia para que cada proyecto crezca de forma escalable, humana y sostenible.
          </p>
        </motion.div>
      </section>
      ...
      <section id="contacto" className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <motion.p initial={fadeUp.initial} whileInView={fadeUp.whileInView} transition={{ ...fadeUp.transition, delay: 0.1 }} viewport={{ once: true }} className="text-center text-gray-400 mb-10">
            ¿Eres empresa, socio o creador interesado en construir el futuro con Tronx Group? Escríbenos o envíanos un mensaje directo.
          </motion.p>

          {/* === FORMULARIO: Zoho WebToLead + reCAPTCHA === */}
          <div id="crmWebToEntityForm" className="crmWebToEntityForm bg-zinc-900/60 border border-zinc-800 rounded-2xl p-6 md:p-8 shadow-lg" style={{ backgroundColor: 'transparent', color: 'white', maxWidth: '100%' }}>
            <form
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    maxLength={100}
                    autoComplete="email"
                    data-ftype="email"   // para la validación Zoho-like
                    aria-required="true"
                    aria-label="Email"
                    className="w-full rounded-xl bg-black/40 border border-zinc-700 px-4 py-3 outline-none focus:ring-2 focus:ring-white/20"
