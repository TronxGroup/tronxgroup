        ...
        <section id="unidades" className="scroll-mt-24 space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card
              ...
              desc="Sitios modernos, medición y flujos conectados a CRM para equipos comerciales y comunicaciones."
              bullets={[
            ...
            <Card
              ...
              desc="Directorio y editorial del eje Santiago–Rancagua–Valparaíso. Activo propio de largo plazo conectado a economía local."
              bullets={[
